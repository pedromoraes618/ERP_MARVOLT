...
<?php
                ...
                $inserir .= "( data_movimento,data_a_pagar,receita_despesa,status,forma_pagamentoID,clienteID,descricao,documento,grupoID,valor,numeroPedido,cl_conta_financeira_id,numeroNotaFiscal )";
                $inserir .= " VALUES ";
                $inserir .= "( '$hoje','$dataApagar','Receita','A Receber','$formaPagamento','$cliente','$menagem','$documento','15','$valor','$numeroPedidoCompra','$conta_financeira','$numeroNfeB')";
                ...
                $select = "SELECT sum(valor) as totalPedido from lancamento_financeiro WHERE numeroPedido = '$nPedido' and receita_despesa ='Receita'";
                $lista_total_financeiro = mysqli_query($conecta, $select);
                if (!$lista_total_financeiro) {
                    die("Falha no banco de dados || select somatorio financeiro");
                } else {
...
if (isset($_POST['salvar']) or (isset($_GET['nPedido']))) {
    $select = "SELECT lncf.data_movimento,lncf.data_a_pagar,lncf.documento,lncf.valor,lncf.lancamentoFinanceiroID,ctfn.cl_banco
     as banco from lancamento_financeiro as lncf inner join tb_conta_financeira as ctfn on ctfn.cl_id =lncf.cl_conta_financeira_id WHERE numeroPedido = '$nPedido' and lncf.receita_despesa ='Receita'";
                    ...
                    <form action="" method="post">
                        <table style="float:left; width:1400px; margin-bottom: 10px; border:1px solid;">
                            <table style="float:right; ">
                                <button type="button" style="float:right" name="btnfechar" onclick="window.opener.location.reload();fechar();" class="btn btn-secondary">Voltar</button>
                                </td>
                            </table>
                        ...
                        <table style="float:left; width:1400px; margin-bottom: 10px;border-bottom:1px solid #ddd; ; ">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input readonly type="text" size=10 id="txtNumeroPedido" name="txtNumeroPedido" value="<?php
                        ...
                        <table style="float:left; width:850px; margin-bottom:30px">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <select style="margin-right: 60px; margin-bottom:10px; width:580px;" id="campoCliente" name="txtCliente"><?php
                                                                                                                                                $meuCliente = $clienteB;
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" size=10 id="valorDocumento" name="valorDocumento" value="<?php
                                                                                                                ...
                                                                                                                ?>"> <input type="submit" id="" name="salvar" class="btn btn-success" value="Adicionar">
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <tbody>
                                        ...
                                        if ($nPedido != "") {
                                            ...
                                            while ($linha = mysqli_fetch_assoc($lista_financeiro)) {
                                                ...
                                                $valor_total = $valorB + $valor_total;
                                        ?>
                                                ...
                                                <tr id="linha_pesquisa">
                                                    ...
                                                    <td id="botaoEditar">
                                                        ...
                                                        <a onclick="window.open('../financeiro/editar_receita.php?codigo=<?php echo $lancamentoID; ?>', 
'editar_produto_cotacao', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                                            ...
                                            <tr id="cabecalho_pesquisa_consulta">
                                                ...
                                                <td>
                                                    <font size="2"><?php echo real_format($valor_total); ?> </font>
                                                </td>
                                                <td>
