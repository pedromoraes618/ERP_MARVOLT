...
if(isset($_POST['btnsalvar'])){
   ...
   $alterar = "UPDATE tb_pedido_item set produto = '{$nomeProduto}', quantidade = '{$qtdProduto}', preco_compra_unitario = '{$precoCompra}',  preco_venda_unitario = '{$precoVenda}' ,  margem = '{$margem}' ,  unidade = '{$unidade}', status_compra = '{$statusCompra}',categoria_produto = '{$categoria_prod}' WHERE pedido_itemID = {$codProduto} and pedidoID = {$codPedido} ";
        ...
        <div style="margin:0 auto; width:1400px; ">
                ...
                <tr>
                    ...
                    <form action="" method="post">
                        ...
                        <td> <input id="remover" type="submit" name="btnremover" value="Remover" class="btn btn-danger"
                                onClick="return confirm('Confirmar Remoção do produto codigo  = <?php echo $codProduto;?>');"></input>
                        </td>
            ...
            <table style="float:left; ">
                <tr>
                    ...
                    <td align=left><select style="width: 170px; margin-right:10px;" id="campoCategoriaProd"
                            name="campoCategoriaProd">
