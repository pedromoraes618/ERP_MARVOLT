...
if ($_GET) {
    ...
    $select = "SELECT  clientes.nome_fantasia,forma_pagamento.banco as banco, forma_pagamento.nome,lancamento_financeiro.descricao,grupo_lancamento.nome  as grupo, 
    lancamento_financeiro.grupoID as subgrupoID, lancamento_financeiro.lancamentoFinanceiroID, tb_subgrupo_receita_despesa.subgrupo, tb_subgrupo_receita_despesa.subgrupo, 
    lancamento_financeiro.data_movimento,  lancamento_financeiro.documento,lancamento_financeiro.lancamentoFinanceiroID,  lancamento_financeiro.data_a_pagar,
     lancamento_financeiro.status,lancamento_financeiro.valor,lancamento_financeiro.documento,  lancamento_financeiro.receita_despesa from  clientes 
      inner join lancamento_financeiro on lancamento_financeiro.clienteID = clientes.clienteID inner join tb_subgrupo_receita_despesa on 
      lancamento_financeiro.grupoID = tb_subgrupo_receita_despesa.subGrupoID inner join forma_pagamento on lancamento_financeiro.forma_pagamentoID = forma_pagamento.formapagamentoID 
    ...
    <main>
        ...
        <div id="janela_pesquisa">
            ...
            <form style="width:100%;" action="" method="get">
                <div id="BotaoLancar">
                    <a onclick="window.open('lancar_receita.php', 
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                    ...
                    <a onclick="window.open('lancar_despesa.php', 
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                ...
                <tr>
                    ...
                    <input style="width: 100px; margin-left:50px" type="text" name="CampoPesquisaDoc" placeholder="N° documento" value="<?php if (isset($_GET['CampoPesquisaDoc'])) {
                                                                                                                                            echo $pesquisaDoc;
                                                                                                                                        } ?>">

                    <td>
                        <input style="margin-left:110px; width:350px" type="text" name="CampoPesquisa" placeholder="pesquisa / Empresa" value="<?php if (isset($_GET['CampoPesquisa'])) {
                                                                                                                                                    echo $pesquisa;
                                                                                                                                                } ?>">
                    ...
                    <td>
                        ...
                        <select style="width: 100px; float:right; margin-right:70px;" id="campoLancamento" name="campoLancamento">
                    ...
                    <td>
                        <select style="width: 100px; float:right; margin-right:10px; " id="campoSubGrupo" name="campoSubGrupo">
                            <option value="0">Selecione</option>
                            <?php
                ...
                <tbody>
                    ...
                    if (isset($_GET["CampoPesquisa"])) {
                        ...
                        while ($linha_pesquisa = mysqli_fetch_assoc($lista_pesquisa)) {
                            ...
                            $subGrupoID = $linha_pesquisa["subgrupoID"];
                            $banco = $linha_pesquisa["banco"];

                            if($statusL =="Recebido" or $statusL =="A Receber"){
                                $valor_total_receita = $valorL + $valor_total_receita;
                            }elseif($statusL=="Pago" or $statusL == "A Pagar"){
                                $valor_total_pago= $valorL + $valor_total_pago;
                            }else{
                            
                            }
                         
                            // //script para atualizar coluna coluna_financeira
                            // $alterar = "UPDATE lancamento_financeiro set cl_conta_financeira_id = $banco WHERE lancamentoFinanceiroID = $lancamentoID ";
                            ...
                            <tr id="linha_pesquisa">
                                ...
                                <td >
                                    <p>
                                        <font size="2"> <?php if ($dataMovimentoL == "0000-00-00") {
                                                            ...
                                                            echo formatardataB($dataMovimentoL);
                                                        } ?></font>
                                    </p>
                                </td>
                                ...
                                <td >
                                    <font size="2"> <?php if ($dataVencimentoL == "0000-00-00") {
                                                        ...
                                                        echo formatardataB($dataVencimentoL);
                                                    } ?></font>
                                </td>
                                ...
                                <td>
                                    <font size="2"> <?php echo ($receite_despesa);
                                                    ...
                                                    ?>
                                            <i title="Receita" style="font-size: 20px;color:forestgreen; margin-left:10px" class="fa-solid fa-money-bill-trend-up"></i>
                                        <?php
                                                    }
                                                    if ($receite_despesa == "Despesa") {

                                        ?>
                                            <i title="Despesa" style="font-size: 20px;color:red; margin-left:10px" class="fa-solid fa-money-bill-transfer"></i><?php
                                                                                                                                                            }
                                                                                                                                                                ?>
                                    </font>
                                </td>
                                ...
                                ?>
                                        <td id="botaoEditar">
                                            ...
                                            if ($receite_despesa == "Receita") {
                                            ?>
                                                <a onclick="window.open('editar_receita.php?codigo=<?php echo $lancamentoID ?>', 
        'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                                            ...
                                            if ($receite_despesa == "Despesa") {
                                            ?>
                                                <a onclick="window.open('editar_despesa.php?codigo=<?php echo $lancamentoID ?>', 
        'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                                                    <button type="button" name="Editar">Editar</button>
        ...
        'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                    ...
                    <tr id="cabecalho_pesquisa_consulta">
                        ...
                        <td style="width: 80px;">
                            <p><?php echo real_format($valor_total_receita - $valor_total_pago); ?></p>
                        </td>
                        <td>
                            <p></p>
                        </td>
