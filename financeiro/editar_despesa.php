...
}elseif(($statusLancamento == "Pago") && ($dataPagamento == "")){
    ?>
...
<?php
    ...
    $alterar .= " forma_pagamentoID = '{$formaPagamento}', clienteID = '{$cliente}', descricao = '{$descricao}', documento = '{$documento}', grupoID = '{$grupoLancamento}', valor = '{$valor}',  observacao  = '{$observacao}', numeroPedido = '{$nPedido}',numeroNotaFiscal = '{$nNotaFiscal}',
    cl_conta_financeira_id='{$conta_financeira}' WHERE lancamentoFinanceiroID = {$lancamentoID} ";
...
<?php
          ...
          $hoje = date('Y-m-d'); 
          //adicionar ao log
          $mensagem = "Usuario editou  um lançamento do tipo: Despesa doc Nº $documento, valor R$ $valor, codigo $lancamentoID ";
...
<?php
            ...
            $insert = "INSERT INTO lancamento_financeiro ";
            $insert .= "( data_movimento,data_a_pagar,data_do_pagamento,receita_despesa,status,forma_pagamentoID,clienteID,descricao,documento,grupoID,valor,observacao,numeroPedido,numeroNotaFiscal,cl_conta_financeira_id )";
            $insert .= " VALUES ";
            $insert .= "( '$dataLancamento','$dataapagar','$dataPagamento','Despesa','$statusLancamento','$formaPagamento','$cliente','$descricao','$documento','$grupoLancamento','$valor','$observacao','$nPedido','$nNotaFiscal','$conta_financeira' )";


              $operacao_duplicar = mysqli_query($conecta, $insert);
              if(!$operacao_duplicar) {
                  die("Erro de insert || insert lancamento_financeiro");   
              } else {  
          
            ?>
<script>
alertify.success("Lançamento duplicado");
</script>
<?php

$hoje = date('Y-m-d'); 
//adicionar ao log
$mensagem = "Usuario duplicou o lançamento Nº $lancamentoID tipo: Depesa doc Nº $documento, valor R$ $valor ";
$inserir = "INSERT INTO tb_log";
$inserir .= "(cl_data_modificacao,cl_usuario,cl_descricao)";
$inserir .= " VALUES ";
$inserir .= "('$hoje','$user','$mensagem' )";
...
if(isset($_POST['btnremover'])){
    ...
    if(($statusLancamento =="Pago" or $statusLancamento =="Cancelado") and (verifica_caixa_descricao($conecta,$mes_caixa,$ano_caixa) == "fechado")){
        //reformatar data
...
$hoje = date('Y-m-d'); 
//adicionar ao log
$mensagem = "Usuario removeu o lançamento do tipo: Despesa codigo $lancamentoID";
$inserir = "INSERT INTO tb_log";
$inserir .= "(cl_data_modificacao,cl_usuario,cl_descricao)";
$inserir .= " VALUES ";
$inserir .= "('$hoje','$user','$mensagem' )";
                        ...
                        <table style="float:left; width:650px; margin-bottom:30px; ">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" <?php if(isset($_GET['provisionamento'])){
                                        ?>readonly
                                        <?php
                                    } ?> size=15 name="campoValor" id="campoValor"
                                ...
                                <td>
                                    ...
                                    <input   style="width: 212px; margin-right:27px" type="text" size=20 name="numeroPedido" id="numeroPedido" value="<?php 
                                        ...
                                        echo $BnPedido;}?>">
                                            ...
                                            NFE:</b></label>
                                    <input type="text" size=16 name="numeroNotaFiscal" id="numeroNotaFiscal" value="<?php 
                                        if($_POST){
                                            echo $nNotaFiscal;
                                        }else{
                                            echo $BnNotaFiscal;
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="margin-left:100px;">
                                        ...
                                        <input type="submit"
                                            onClick="return confirm('Deseja duplicar esse lançamento?');"
                                            name=btnDuplicar value="Duplicar" class="btn btn-info btn-sm"></input>
