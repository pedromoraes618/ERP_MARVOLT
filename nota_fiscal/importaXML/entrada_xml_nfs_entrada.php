...
<body>
    ...
    <form method="post" action="entrada_xml_entrada.php ">
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            ...
            <?php
                    ...
                    if ($codigo_autenticacao != "") {
                        $select = " SELECT * from tb_nfs_entrada where codigo_autenticacao = '$codigo_autenticacao' ";
            ...
            <?php
                            ...
                            ?> <?php
                                    ...
                                    $insert = "INSERT INTO tb_nfs_entrada ";
...
'$descIncondicionado','$vLiquidoServico','$OutrasInformacoes_b','$id_referencia','$issRepetido')";
            ...
            <?php
            $mensagem = "Usuario importou a nota de seviço Nº $nNF via xml ";
            ...
            <?php
                    if ($codigo_autenticacao != "") {
                        $select = " SELECT * from tb_nfs_item_entrada where codigo_autenticacao = '$codigo_autenticacao' ";
                        $consulta = mysqli_query($conecta, $select);
                        if (!$consulta) {
                            die("Falha na consulta ao banco de dados Usuraio");
                        } else {
                    ...
                    ?> <?php
                                    ...
                                    $insert = "INSERT INTO tb_nfs_item_entrada ";
