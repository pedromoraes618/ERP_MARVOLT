...
?>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            ...
            <tr class="cor1">
                <td align="center"><input type="text" name="razao_social" size="60" value="<?php echo $emit_xNome ?>"
                ...
                <td align="center"><input type="text" class="cor1" name="IE" size="15" value="<?php echo $emit_IE ?>"
                        readonly="readonly" /></td>
            </tr>
        </table>
        <?php
