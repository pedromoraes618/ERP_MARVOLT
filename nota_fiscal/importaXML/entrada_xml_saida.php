...
?>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            ...
            <tr class="cor1">
                ...
                <td align="center" width="0%"><input type="text" name="chave" size="55" class="cor1"
...
?>
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr class="cor0">
                <td align="center" width="0%">DADOS DO CLIENTE</td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            ...
            <tr class="cor1">
                <td align="center"><input type="text" name="razao_social" size="60" value="<?php echo $dest_xNome ?>"
                        readonly="readonly" class="cor1" /></td>
                <td align="center"><input class="cor1" type="text" id="cnpj" name="cnpj" size="15"
                        value="<?php echo $dest_cnpj ?>" readonly="readonly" /></td>
                <td align="center"><input type="text" class="cor1" name="IE" size="15" value="<?php echo $dest_IE ?>"
                        readonly="readonly" /></td>
            </tr>
        </table>
        <?php
...
?>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr class="header-fixa">
                <td align="center">BC do ICMS</td>
                <td align="center">Valor do ICMS</td>
                <td align="center">BC ICMS ST</td>
                <td align="center">Valor do ICMS ST</td>
                <td align="center">Vl Total dos Produtos</td>
            </tr>
            <tr class="cor1">
                <td align="center" width="0%"><input type="text" name="vBC" size="15" class="cor1"
                        value="<?php echo $vBC ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vICMS" size="15" class="cor1"
                        value="<?php echo $vICMS ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vBCST" size="15" class="cor1"
                        value="<?php echo $vBCST ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vST" size="15" class="cor1"
                        value="<?php echo $vST ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vProd" size="15" class="cor1"
                        value="<?php echo $vProdProduto ?>" readonly="readonly" /></td>
            </tr>
        </table>
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr class="header-fixa">
                ...
                <td align="center">Vl Total do IPI</td>
                <td align="center">Vl Total da Nota</td>
            </tr>
            <tr class="cor1">
                <td align="center" width="0%"><input type="text" name="vFrete" size="15" class="cor1"
                        value="<?php echo $vFrete ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vSeg" size="15" class="cor1"
                        value="<?php echo $vSeg ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vDesc" size="15" class="cor1"
                        value="<?php echo $vDesc ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vIPI" size="15" class="cor1"
                        value="<?php echo $vIPI ?>" readonly="readonly" /></td>
                <td align="center" width="0%"><input type="text" name="vNF" size="15" class="cor1"
...
?>
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
            <tr class="header-fixa">
                ...
                <td width="35%" align="center">Descri&ccedil;&atilde;o dos produto(s)/Servi&ccedil;o(s)</td>
                <td width="5%" align="center">NCM</td>
                <td width="5%" align="center">CFOP</td>
                <td width="5%" align="center">Un</td>
                <td width="5%" align="center">Qtde</td>
                <td width="5%" align="center">Vlr Unit&aacute;rio</td>
...
?>
            <tr <?php echo $class ?>>
                ...
                <td><input type="text" <?php echo $class ?> name="vUnCom[]" size="10" value="<?php echo $vUnCom ?>"
                        readonly="readonly" /></td>
                <td><input type="text" <?php echo $class ?> name="vProd[]" size="10" value="<?php echo $vProdItem ?>"
                        readonly="readonly" /></td>
            ...
            <?php
			if($chave!=""){
				$select = " SELECT * from tb_nfe_saida where chave_acesso = '$chave' ";
			   ...
			   if($chave == $chave_acesso){
				   ...
				   if($dest_cnpj!=""){
					   $select = " SELECT * from clientes where cpfcnpj = '$dest_cnpj' ";
		...
		$inserirIten = "INSERT INTO tb_nfe_saida_item ";
		...
		$inserirIten .= " VALUES ";
		$inserirIten .= "( '$nNF','$codigo','$xProd','$NCM','$CFOP','$uCom','$qCom','$vUnCom', '$vProdItem','$bc_icms','$vlr_icms','$vlr_ipi','$pICMS','$perc_ipi' )";
		
		$operacao_inserir_iten = mysqli_query($conecta, $inserirIten);
		if(!$operacao_inserir_iten){
			die("Erro no banco de dados || tabela tb_nfe_saida_item ");
		}
	}
}
}
...
//Autoriza��o
	...
	$nProt = $xml->protNFe->infProt->nProt;
        ...
        <?php 
				...
				$dest_xNome = utf8_decode($dest_xNome);
	...
	$inserir .= "( '$hoje','$chave','$nNF','$nProt','$serie','$dEmi','$dSaiEnt','$dest_xNome','$dest_cnpj','$dest_IE','$vBC','$vICMS','$vBCST','$vST','$vFrete','$vSeg','$vDesc','$vIPI','$vProdTotal','$vNF','1' )";
				...
				if(!$operacao_inserir){
					?>
        <script>
        alertify.alert("Erro nota fiscal, nota não foi importada para o sistema!");
        </script>
        <?php 
