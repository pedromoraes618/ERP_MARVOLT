...
$nFE =  $_GET["codigo"];
$consulta = "SELECT * from tb_nfe_entrada  WHERE numero_nf = '$nFE'";
...
<?php
        ...
        $mensagem = "Usuario removeu a nota de compra nº $numero_nf";
        ...
        <div style="margin:0 auto; width:1500px; ">
            ...
            <table style="float: right; ">
                ...
                <tr>
                    ...
                    <form action="" method="post">
                        <td><input id="remover" type="submit" name="btnremover" value="Remover" class="btn btn-danger" onClick="return confirm('Deseja remover essa nota fiscal? Lembrando o provisionamento também será removido do financeiro');"></input></td>
                        <td align=left> <button type="button" name="btnfechar" onclick="fechar();" class="btn btn-secondary">Voltar</button>
                        </td>
            ...
            <table style="float:left;">
                ...
                <tr>
                    ...
                    <td align=left><input type="text" name="campoDataEntrada" size="10" value="<?php if ($dataEntrada == "1970-01-01") {
                                                                                                    ...
                                                                                                    echo formatardataB($dataEntrada);
                                                                                                } ?>" autocomplete="off"></td>
            ...
            <table style="float:left;">
                <tr>
                    ...
                    <td align=left> <input type="text" name="campoNnota" size="10" autocomplete="of" value="<?php echo $nFE ?>"> </td>

                    <td align=left> <b>Serie:</b></td>
                    <td align=left> <input type="text" name="campoSerie" size="10" autocomplete="of" value="<?php echo $serie ?>"> </td>
