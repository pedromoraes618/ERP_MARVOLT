...
if(isset($_POST['salvar_juros'])){
    ...
    if($valorJuros ==""){
        ?>
<script>
alertify.alert("Favor informe o juros");
</script>
<?php
    }elseif($formaPagamento == "0"){
        ?>
                    ...
                    <form action="" method="post">
                        ...
                        <table style="float:left; width:1400px; margin-bottom: 10px;border-top:1px solid #ddd; ; ">
                            ...
                            <tr>
                                ...
                                <td> <input type="text" id="vlrJuros" name="vlrJuros" value="<?php
                                       if(isset($_POST['vlrJuros'])){
                                        echo $valorJuros;
                                    }
                                    ?>" maxlength="10" autocomplete="off">
                                    <input type="submit" id="" style="width:150px ;" name="salvar_juros"
                                        class="btn btn-success" value="Adicionar Juros">
                                </td>
                            </tr>
                        </table>
...
?>
                                    ...
                                    <tr id="linha_pesquisa">
                                        ...
                                        <td id="botaoEditar">
                                            ...
                                            <a
                                                onclick="window.open('../financeiro/editar_despesa.php?codigo=<?php echo $lancamentoID;?>&provisionamento=true', 
