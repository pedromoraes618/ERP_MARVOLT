...
if(isset($_POST['salvar'])){
    ...
    $mensagem = utf8_decode("Duplicata $documento referente a nota fiscal de serviço $nNfe");
    $salvar = $_POST['salvar'];
    
    $select = "SELECT sum(valor) as total from lancamento_financeiro WHERE numeroNotaFiscal = '$nNfe' and id_referencia = $id_referencia";
...
<?php
            ...
            if( $_SERVER['REQUEST_METHOD']=='POST' )
            {
                ...
                else
                {
                    ...
                    $inserir .= "( data_movimento,data_a_pagar,receita_despesa,status,forma_pagamentoID,clienteID,descricao,documento,grupoID,valor,numeroNotaFiscal,id_referencia)";
                    $inserir .= " VALUES ";
                    $inserir .= "( '$hoje','$dataApagar','Receita','A Receber','$formaPagamento','$cliente','$mensagem','$documento','15','$valor','$nNfe','$id_referencia' )";
...
if(isset($_POST['salvar'])or (isset($_GET['codigo']))){
    $select = "SELECT * from lancamento_financeiro WHERE numeroNotaFiscal = '$nNfe' and id_referencia = $id_referencia";
