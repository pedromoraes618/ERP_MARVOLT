    ...
    <div class="bloco_principal ">
        <div class="row  mb-2">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end ">
                <button type="button" id="concluir_venda" onclick="calcula_v_liquido()" class="btn btn-sm btn-success">Salvar</button>
                <button type="button" id="modal_observacao" class="btn btn-sm btn-dark">Informação adicionais</button>
                <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">Fechar</button>
            </div>
        </div>
        <div class="card">
            <form class="form_principal" id="tela_nota_fiscal">
                <div class="row mb-2">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md mb-2">
                        <label for="descricao" class="form-label">Chave de acesso</label>
                        <input type="text" class="form-control" disabled id="chave_acesso" name="chave_acesso" value="">
                    </div>
                    <div class="col-md  mb-2">
                        <label for="referencia" class="form-label">Protocolo</label>
                ...
                <div class="row border-success">
                    ...
                    <div class="col-md-2  mb-2">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="outras_despesas" id="outras_despesas" value="">
                        </div>
                    </div>
                    <div class="col-md-2  mb-2">
                    ...
                    <div class="col-md-2  mb-2">
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text">R$</span>
                            <input type="text" class="form-control" name="desconto_nota" id="desconto_nota" value="">
                        </div>
                    </div>
                    <div class="col-md-2  mb-2">
