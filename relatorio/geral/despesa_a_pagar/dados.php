    ...
    <table border="0" whidth="100%" cellspacing="0">
        ...
        $valor_total = 0;
            ...
            <tr>
                ...
                <td>
                    <p style="color: red;">Empréstimo 2023</p>
                </td>
                <td>
                    <p>Empréstimo</p>
                </td>
                <td>
                    <p><?php echo real_format($valor_total_apartir_2023); ?></p>
                </td>
            ...
            <tr>
                ...
                <td>
                    <p  style="color: red;" >Empréstimo 2024</p>
                </td>
                <td>
                    <p>Empréstimo</p>
                </td>
                <td>
                    <p><?php echo real_format($valor_total_apartir_2024); ?></p>
                </td>
            ...
            <tr class="valor_total">
                ...
                <td></td>
                <td><?php 
                $valor_total = $valor_total + $valor_total_apartir_2024 + $valor_total_apartir_2023;
                echo real_format($valor_total); ?></td>
            </tr>
