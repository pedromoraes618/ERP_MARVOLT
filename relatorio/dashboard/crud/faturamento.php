...
if (isset($_GET['filtroano']) and (isset($_GET['filtromesini']) and (isset($_GET['filtromesfim'])))) {
    ...
    inner join clientes as clt on clt.clienteID = nfes.cliente_id where nfes.finalidade_id = '1' and  nfes.data_emissao between '$ano-$mes_ini-01' and '$ano-$mes_fim-31' 
    ...
    $select = "SELECT sum(valor_total_nota) as valor_total_nfe_saida from tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano_anterior-01-01' and '$ano_anterior-12-31' ";
    ...
    $select = "SELECT sum(valor_total_nota) as valor_total_nfe_saida from tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano-01-01' and '$ano-12-31' ";
    ...
    $select = "SELECT sum(valor_total_nota) as valor_total_nfe_saida,count(*) as qtdnfes  from tb_nfe_saida where finalidade_id = '1' and data_emissao 
    between '$ano-$mes_ini-01' and '$ano-$mes_fim-31' ";
    ...
    on pdc.numero_nf = nfes.numero_nf where nfes.finalidade_id = '1' and nfes.data_emissao between '$ano-$mes_ini-01' and '$ano-$mes_fim-31'";
    ...
    function consultar_faturamento_nfes($i, $ano)
    {
        ...
        tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano-$i-01' and '$ano-$i-31' ";
        $consultar_valor_total_nfe_saida = mysqli_query($conecta, $select);
        $linha = mysqli_fetch_assoc($consultar_valor_total_nfe_saida);
    ...
    function consultar_quantidade_nfes_total($ano)
    {
        ...
        tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano-01-01' and '$ano-12-31'";
    ...
    if (isset($_GET['cliente_id'])) {
        ...
        function consultar_faturamento_nfes_cliente($i, $ano,$clientecnpj, $cliente_id)
        {
            include("../../../conexao/conexao.php");
            $select = "SELECT sum(valor_total_nota) as valor_total from  
            tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano-$i-01' and '$ano-$i-31' and cliente_id = '$cliente_id' ";
            $consultar_valor_total_nfe_saida = mysqli_query($conecta, $select);
            $linha = mysqli_fetch_assoc($consultar_valor_total_nfe_saida);
            $valor_total_nfe_saida = $linha['valor_total'];
            ...
            //valor total nfs saida
            $select = "SELECT sum(vLiquido_servico) AS valor_total, count(*) as qtdnfss from tb_nfs where dt_emissao
             between '$ano-$i-01' and '$ano-$i-31' and cnpj_tomador = '$clientecnpj' ";
            $consultar_valor_total_nfs_saida = mysqli_query($conecta, $select);
            $linha = mysqli_fetch_assoc($consultar_valor_total_nfs_saida);
            $valor_total_nfs_saida = $linha['valor_total'];
            $valor_total_nota_fiscal = $valor_total_nfe_saida + $valor_total_nfs_saida;
        ...
        function consultar_quantidade_nfes_cliente($i, $ano, $clientecnpj, $cliente_id)
        {
            include("../../../conexao/conexao.php");
            $select = "SELECT count(*) as qtdnfes from  
            tb_nfe_saida where finalidade_id = '1' and data_emissao between '$ano-$i-01' and '$ano-$i-31' and cliente_id = '$cliente_id' ";
        ...
        //valor total nfe saida
        $select = "SELECT sum(valor_total_nota) as valor_total_nfe_saida,count(*) as qtdnfes  from tb_nfe_saida where finalidade_id = '1' and data_emissao
         between '$ano-$mes_ini-01' and '$ano-$mes_fim-31' and cliente_id = '$clienteid' ";
        $consultar_valor_total_nfe_saida = mysqli_query($conecta, $select);
        $linha = mysqli_fetch_assoc($consultar_valor_total_nfe_saida);
        $valor_total_nfe_saida = $linha['valor_total_nfe_saida'];
        $quantidade_nfe_saida = $linha['qtdnfes'];
        ...
        //margem 
        $select = "SELECT sum(nfes.valor_total_nota) as valorVenda, sum(pdc.valor_total_compra) as valorCompra from tb_nfe_saida as nfes inner join pedido_compra as pdc 
     on pdc.numero_nf = nfes.numero_nf where nfes.finalidade_id = '1' and nfes.data_emissao between '$ano-$mes_ini-01' and '$ano-$mes_fim-31'and
      nfes.cliente_id = '$clienteid'";
        $consulta_valor_margem = mysqli_query($conecta, $select);
        $linha = mysqli_fetch_assoc($consulta_valor_margem);
        $valor_total_venda = $linha['valorVenda'];
        $valor_total_compra = $linha['valorCompra'];
