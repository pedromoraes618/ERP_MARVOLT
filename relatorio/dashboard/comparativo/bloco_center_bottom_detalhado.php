...
<div class="relatorio_center_top">
    <div class="title">
        <h4>Pedido de compra - <?PHP echo $cliente_nome; ?> </h4>
    </div>
    ...
    <div class="bloco">
        ...
        <div class="bloco-1">
            <div>
                <canvas width="800" height="140" id="barchart_bottom"></canvas>
            </div>


            <script>
            var ctx = document.getElementById("barchart_bottom").getContext('2d');
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                            ...
                            echo       "'".(consular_receita_mes_detalhado_pdc($i,$ano,$clienteID) - consular_despesa_mes_detalhado_pdc($i,$ano,$clienteID))  ."',";
                        }
                            ?>
                            ],
                        },
                        {
                            ...
                            $i = $i+ 1;
                            //verificar a quantidade de receita por mes 
                            echo       "'". consular_receita_mes_detalhado_pdc($i,$ano,$clienteID) ."',";
                            }
                            ?>
                            ],
                        },
                        {
                            ...
                            echo       "'". consular_despesa_mes_detalhado_pdc($i,$ano,$clienteID) ."',";
                            }
                            ?>
                            ],
