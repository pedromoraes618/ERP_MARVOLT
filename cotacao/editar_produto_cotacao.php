...
if (isset($_POST['btnremover'])) {
    ...
    $link = utf8_decode($_POST["campoLink"]);
...
if (isset($_POST['btnCadastrar'])) {
    ...
    $prazo_entrega = utf8_decode($_POST['campoPrazo']);
    $categoria_prod =  utf8_decode($_POST['campoCategoriaProd']);
    ...
    ?>
        ...
        $inserirProduto .= "( '$hoje','$nomeProduto','$precoVenda','$precoCompra','$unidade','$categoria_prod','1')";
...
if (isset($_POST['btnsalvar'])) {
    ...
    $prazo_entrega = utf8_decode($_POST['campoPrazo']);
    $categoria_prod =  utf8_decode($_POST['campoCategoriaProd']);
    $codigo_avulso = utf8_decode($_POST['codigo_avulso']);

    //query para alterar o produto da cotacao no banco de dados
    $alterar_produto = "UPDATE produto_cotacao set descricao = '{$nomeProduto}', quantidade = '{$qtdProduto}', preco_compra = '{$precoCompra}',  preco_venda = '{$precoVenda}' , 
     margem = '{$margem}' ,  unidade = '{$unidade}', status = '{$statusProduto}', prazo = '{$prazo_entrega}',categoria_produto ='{$categoria_prod}',link='$link' ,codigo_avulso='{$codigo_avulso}' WHERE produto_cotacao = {$codProduto}  ";
...
if (!$detalhe) {
    ...
    $categoria_prodB =  utf8_encode($dados_detalhe['categoria_produto']);
    $prazo =  utf8_encode($dados_detalhe['prazo']);
    $codigo_avulso =  utf8_encode($dados_detalhe['codigo_avulso']);
    $link_b =  utf8_encode($dados_detalhe['link']);
}
    ...
    <main>
        ...
        <div style="margin:0 auto; width:1400px; ">
            ...
            <table style="float: right;margin-bottom:20px">
                ...
                <tr>
                    ...
                    <form action="" method="post">
                        ...
                        <td align=left> <input type="submit" id="salvar" name="btnsalvar" class="btn btn-success" value="salvar">
                        </td>
                        <td align=left> <input type="submit" id="cadastrar" name="btnCadastrar" class="btn btn-primary" value="Cadastar" onClick="return confirm('Confirmar o cadastro do produto no sistema?');">
                        </td>
                        <td> <input id="remover" type="submit" name="btnremover" value="Remover" class="btn btn-danger" onClick="return confirm('Confirmar Remoção do produto da cotação <?php echo $cotacaoID; ?>');"></input>
                        </td>
                        <td align=left> <button type="button" name="btnfechar" class="btn btn-secondary" onclick="window.opener.location.reload();fechar()">Voltar</button>
                        </td>
            ...
            <table style="float:left; width:900px; margin-top:5px;">
                ...
                <tr>
                    <td>Código:
                        <input style="margin-left:0px;" readonly type="text" size="10" name="codigoProduto" value="<?php echo $codProduto; ?>">
                    </td>

                    <td align=left><input readonly type="hidden" size="10" name="codigoCotacao" value="<?php echo $cotacaoID; ?>"> </td>
                </tr>
            </table>
            ...
            <table style="float:left; ">
                <tr>
                    <td><b>Produto:</b></td>
                    <td align=left><input style="margin-left:0px;" type="text" size=64 name="campoNomeProduto" value="<?php if (isset($_POST['adicionar'])) {
                                                                                                                            echo utf8_encode($nomeProduto);
                    ...
                    <td align=left><select style="width: 170px; margin-right:10px;" id="campoStatusProduto" name="campoStatusProduto">
                    ...
                    <td align=left><input type="text" size=10 name="campoPrazo" id="campoPrazo" value="<?php echo utf8_encode($prazo); ?>">
                    </td>

                    <td align=left><b>Código avulso:</b></td>
                    <td align=left><input type="text" size=10 name="codigo_avulso" id="codigo_avulso" value="<?php echo utf8_encode($codigo_avulso); ?>">
                    </td>
                </tr>
            </table>
            ...
            <table style="float:left;">
                <tr>
                    <div>
                        ...
                        <td align=left><input <?php if (isset($_GET['servico'])) {
                                                    echo 'readonly';
                                                } ?> type="text" size=10 name="campoUnidade" id="campoUnidade" autocomplete="off" value="<?php echo $unidade; ?>">
                        </td>
                        <td align=left><b>Qtd:</b></td>
                        <td align=left><input type="text" size=10 name="campoQtdProduto" id="campoQtdProduto" onblur="calculavalormargem()" autocomplete="off" value="<?php echo $quantidade ?>">
                        </td>
                        <td align=left><b>P. cotado:</b></td>
                        <td align=left><input type="text" size=10 name="campoPrecoCotado" id="campoPrecoCotado" onblur="calculavalormargem()" autocomplete="off" value="<?php echo $precoCompra; ?>">
                        </td>
                        <td align=left><b>Margem:</b></td>
                        <td align=left><input type="text" size=10 name="campoMargem" id="campoMargem" onblur="calculavalorPrecoVenda()" autocomplete="off" value="<?php echo $margem ?>">
                        </td>
                        <td align=left><b>P. venda:</b></td>
                        <td align=left><input type="text" size=10 name="campoVenda" id="campoPrecoVenda" onblur="calculavalormargem()" autocomplete="off" value="<?php echo $precoVenda;
                                                                                                                                                                    ?>">
                        </td>
                        <td align=left> <b>Categoria prod:</b></td>
                        <td align=left><select style="width: 170px; margin-right:10px;" id="campoCategoriaProd" name="campoCategoriaProd">
            ...
            <table style="float:left;">
                <tr>
                    <td  style="width:70px;"><b>Link: </b></td>
                    <td align=left><input style="margin-left:0px;" type="text" size=129 name="campoLink" value="<?php if (isset($_POST['adicionar'])) {
                                                                                                                            echo utf8_encode($link);
                                                                                                                        } elseif (!isset($_POST['adicionar'])) {
                                                                                                                            echo $link_b;
                                                                                                                        } ?>">
                    </td>
                        ...
                        <td>
                            <div id="imgProdutos" style="width:340px; height:200px;padding:20px">
                                ...
                                <ul>
                                    ...
                                    <li><input type="submit" value="Upload" id="upload" class="btn-btn-info" name="enviar_formulario"></li>
                                    <li> <input type="submit" value="Excluir" id="excluirImg" class="btn btn-danger" name="excluirImg"></li>
                                </ul>
                            </div>
                        </td>
