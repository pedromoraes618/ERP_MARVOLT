...
if(isset($_POST['btnsalvar'])){
   ...
   $alterar_produto = "UPDATE produto_cotacao set descricao = '{$nomeProduto}', quantidade = '{$qtdProduto}', preco_compra = '{$precoCompra}',  preco_venda = '{$precoVenda}' ,  margem = '{$margem}' ,  unidade = '{$unidade}', status = '{$statusProduto}', prazo = '{$prazo_entrega}',categoria_produto ='{$categoria_prod}' WHERE produto_cotacao = {$codProduto}  ";
