...
<body>
    ...
    <main>
        ...
        if(isset($_GET["CampoPesquisaData"])){
            $linhas = 0;
            $total_fechados = 0; // produtos fechados
           ...
           ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td style="width:200px;">
                            <?php 
                             ...
                             die("Falha no banco de dados || pesquisar produto cotacao");
                                 ...
                                 $soma_dos_fechados = $linha_soma['soma'];
                                 $soma_produtos_fechados = $soma_dos_fechados;
                             }
                             
                            
                            ?>
                            <font size="2" style="color:green;"><?php echo real_format($soma_dos_fechados);?></font>
                        ...
                        <td>
                            ...
                            $margem = ((1-($soma_dos_fechados/$vlrTotalCotacao))*100);
        ...
        if(isset($_GET["CampoPesquisaData"])){
           ...
           ?>
                        ...
                        <td style="width:200px;">
                            ...
                            $selectProdutoCotacaoTotal =  "SELECT sum(preco_venda*quantidade) as soma, cotacao.clienteID,cotacao.data_lancamento  from produto_cotacao inner join cotacao on produto_cotacao.cotacaoID = cotacao.cod_cotacao  where  cotacao.data_lancamento BETWEEN '$pesquisaData' and '$pesquisaDataf'   and cotacao.status_proposta = 4 and cotacao.clienteID = '{$clienteID}' and produto_cotacao.status = 2 " ;
                             ...
                             die("Falha no banco de dados || pesquisar produto cotacao");
                                 ...
                                 $soma_fechado_parcial = $linha_soma['soma'];
                                 $soma_produtos_fechados_parcial = $soma_fechado_parcial;
                             }
                             
                            
                            ?>
                            <font size="2" style="color:green;"><?php echo real_format($soma_fechado_parcial);?></font>
                        </td>

                        <td>
                            <font size="2" style="color:green;"><?php 
                            $margem = ((1-($soma_fechado_parcial/$vlrTotalCotacao))*100);
                            echo real_percent($margem);
                    ...
                    <?php
                            $total_fechados_parcial = $soma_produtos_fechados_parcial + $total_fechados_parcial;
                    }
                    ...
                    <tr id="cabecalho_pesquisa_consulta">
                        ...
                        <td>
                            <p><?php echo real_format($total_fechados_parcial); ?></p>
                        </td>
                        <td>
                            <p></p>
                        </td>
