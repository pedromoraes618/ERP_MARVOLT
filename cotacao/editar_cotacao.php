...
$inserir .= "( data_lancamento,pedidoID,cod_produto,produto,unidade,quantidade,preco_compra_unitario,preco_venda_unitario,margem,status_compra,categoria_produto)";
$inserir .= " ( SELECT CURDATE(), cotacaoID,cod_produto,descricao,unidade,quantidade,preco_compra,preco_venda,margem*100,'2',categoria_produto FROM produto_cotacao WHERE cotacaoID = '$codCotacao' and status = '2' )";
$operacao_inserir = mysqli_query($conecta, $inserir);
if(!$operacao_inserir){
