...
//inserir o produto
  ...
  $inserir .= "(cotacaoID,numero_orcamento, descricao,quantidade,preco_compra,preco_venda,margem,unidade,status,prazo )";
  $inserir .= " VALUES ";
  $inserir .= "('$codCotacao','$paramentroNumeroOrcamento','$nomeProduto','$qtdProduto','$precoCompra', '$precoVenda', '$margem','$unidade','1','$prazo' )";
