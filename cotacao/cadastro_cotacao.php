...
if($_POST){
    ...
    $categoria_prod = $_POST['campoCategoriaProd'];
    $prazo = $_POST['campoPrazo'];
...
//inserir o produto
  ...
  $inserir .= " VALUES ";
  $inserir .= "('$codCotacao','$paramentroNumeroOrcamento','$nomeProduto','$qtdProduto','$precoCompra', '$precoVenda', '$margem','$unidade','1','$categoria_prod','$prazo' )";
...
$inserir .= " VALUES ";
$inserir .= "('$clienteID','$hoje','$compradorID','$freteID','$statusProposta','$formaPagamento','$dataRecebida','$dataEnvio','$dataResponder','$dataFechamento','$diasNegociacao','$prazoEntrega','$numeroSolicitacao','$paramentroNumeroOrcamento','$codCotacao','$validade','$valorTotal','$desconto','$valorTotalComDesconto','$margemGeral' )";
$operacao_inserir = mysqli_query($conecta, $inserir);
$formaPagamento = "1";
$freteID = "1";
$compradorID = "1";
...
<body>
            ...
            <table style="float: right;">
                ...
                <tr>
                    ...
                    <form action="" autocomplete="off" method="post">
                        ...
                        <td align=left> <button type="button" name="btnfechar" id="voltar_tela"
           ...
           if($_POST){
            ...
            ?>"> </td>
                ...
                <tr>
                    ...
                    <td align=left> <input type="text" id="numero_solicitacao" name="campoNsolitacao" size="10" value="<?php  if($_POST){
     echo $numeroSolicitacao;
    }?>"> </td>

                    <td align=left> <b>Nº orçamento:</b></td>
                    <td align=left> <input type="text" id="numero_orcamento" name="campoNorcamento" size="10" value="<?php 
                    if($_POST){
                        echo $paramentroNumeroOrcamento;
                         }
    ...
    ?>"> </td>
         ...
         ?>
                    ...
                    <td align="left"> <input type="text" id="data_recebida" name="campoDataRecebida"
                            OnKeyUp="mascaraData(this);" size="10" autocomplete="off" maxlength="10"
                            onkeypress="return onlynumber();" value="<?php  if($_POST){
                                echo $dataRecebida; 
                    ...
                    <td> <b>Validade:<b>
                    <td><input type="text" id="validade" autocomplete="off" onkeypress="return onlynumber();"
                            name="campoValidade" size="10" value="<?php if($_POST){
                        echo $validade;
            ...
            <table style="float:left; margin-top:5px; ">
                <tr>
                    ...
                    <td> <input type="text" id="data_responder" name="campoDataResponder" OnKeyUp="mascaraData(this);"
                            size="10" autocomplete="off" maxlength="10" onkeypress="return onlynumber();" value="<?php if($_POST){
                                echo $dataResponder;
            
    }?>"></td>
                    <td align=left><b>Data envio:</b></td>
                    <td align=left><input type="text" id="data_envio" name="campoDataEnvio" OnKeyUp="mascaraData(this);"
                            size="10" autocomplete="off" maxlength="10" onkeypress="return onlynumber();" value="<?php  if($_POST){
                                echo $dataEnvio;
    }?>"></td>
                    ...
                    <td align=left><input type="text" id="data_fechamento" name="campoDaFechamento"
                            OnKeyUp="mascaraData(this);" size="10" autocomplete="off" maxlength="10"
                            onkeypress="return onlynumber();" value="<?php if($_POST){
      echo $dataFechamento;
                     }?>"></td>
...
?>
            ...
            <table style="float:left; ">
                <tr>
                    ...
                    <td align=left><select style="width: 200px;" name="campoCategoriaProd" id="campoCategoriaProd">
...
<script>
//valores dos campos    
var cd_cotacao = document.getElementById('codigo_cotacao');
var numero_solicitacao = document.getElementById('numero_solicitacao');
var numero_orcamento = document.getElementById('numero_orcamento');
var campoFormaPagamento = document.getElementById('campoFormaPagamento');
var data_recebida = document.getElementById('data_recebida');
var validade = document.getElementById('validade');
var data_responder = document.getElementById('data_responder');
var data_envio = document.getElementById('data_envio');
var data_fechamento = document.getElementById('data_fechamento');
var campoStatusProposta = document.getElementById('campoStatusProposta');
var campoFrete = document.getElementById('campoFrete');
var campoCliente = document.getElementById('campoCliente');
...
var campoValorTotalHidden = document.getElementById('campoValorTotalHidden');
var txtValorMargem = document.getElementById('txtValorMargem');
...
$("#voltar_tela").click(function(e) {
    // onclick=""
    if (cd_cotacao.value != "") {
        Swal.fire({
            title: 'Tem certeza?',
            text: "A cotação foi iniciada e não finalizada, Deseja continuar essa cotação",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                // $.ajax({
                //     type: "POST",
                //     data: "codigo_cotacao=" + cd_cotacao.value + "&numero_solicitacao=" +
                //         numero_solicitacao.value + "&numero_orcamento=" + numero_orcamento
                //         .value + "&campoFormaPagamento=" + campoFormaPagamento.value +
                //         "&data_recebida=" + data_recebida.value + "&validade=" + validade
                //         .value +
                //         "&data_responder=" + data_responder.value + "&data_envio=" + data_envio
                //         .value + "&data_fechamento=" + data_fechamento.value +
                //         "&campoStatusProposta=" + campoStatusProposta.value + "&campoFrete=" +
                //         campoFrete.value + "&campoCliente=" + campoCliente.value +
                //         "&campoComprador=" + campoComprador.value + "&campoDesconto=" +
                //         campoDesconto.value + "&campoValorTotal=" + campoValorTotal.value +
                //         "&campoValorTotalHidden=" + campoValorTotalHidden.value +
                //         "&txtValorMargem=" + txtValorMargem.value,
                //     url: "crud.php",
                //     async: false
                // }).then(sucesso, falha);
