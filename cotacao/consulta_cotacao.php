...
if (isset($_GET["CampoPesquisa"]) && ["CampoPesquisaData"] && ["CampoPesquisaDataf"]) {
    ...
    $pesquisa = $_GET["CampoPesquisa"];
    $pesquisa_produto = $_GET["CampoProduto"];
    $pesquisaNorcamento = $_GET["CampoPesquisaNorcamento"];
    $situacao = $_GET['campoSituacao'];
...
<body>
    ...
    <main>
        ...
        <div style=" width:1490px;" id="janela_pesquisa">
            <ul>
                <li>
                    <b> Data lançamento</b>
                </li>
                <li style="margin-left: 920px;">
                    <b> Situação</b>
                </li>
...
'Cadastro_cotacao', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1600, HEIGHT=900');">
                ...
                <a onclick="window.open('cadastro_cotacao_avulso.php', 
'Cadastro_cotacao', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1600, HEIGHT=900');">
                    <input type="submit" name="cadastrar_cotacao" value="Avulso" style="margin-right:10px ;">
                </a>


                <!-- <input type="submit" name="pesquisar_produo" id="pesquisar_produo"  value="P. produto" style="margin-right:10px; background-color:darkgoldenrod;">
         
 -->



                <input style="width: 100px; " type="text" id="CampoPesquisaData" name="CampoPesquisaData" placeholder="Data incial" onkeyup="mascaraData(this);" value="<?php if (!isset($_GET["CampoPesquisaData"])) {
                ...
                <input style=" width: 100px;" type="text" name="CampoPesquisaDataf" placeholder="Data final" onkeyup="mascaraData(this);" value="<?php if (!isset($_GET["CampoPesquisaDataf"])) {
                                                                                                                                                        echo date('d/m/Y');
                                                                                                                                                    }
                                                                                                                                                    if (isset($_GET["CampoPesquisaDataf"])) {
                                                                                                                                                        echo $pesquisaDataf;
                ...
                <input style="width: 100px; margin-left:50px" type="text" name="CampoPesquisaNorcamento" placeholder="N° Orçamento" value="<?php if (isset($_GET['CampoPesquisaNorcamento'])) {
                                                                                                                                                echo $pesquisaNorcamento;
                                                                                                                                            } ?>">

                <input style="margin-left:50px; width:250px" type="text" name="CampoProduto" id="CampoProduto" value="<?php if (isset($_GET['CampoProduto'])) {
                                                                                                                            echo $pesquisa_produto;
                                                                                                                        } ?>" placeholder="Pesquisa / Produto">

                <input style="margin-left:10px;width:250px" type="text" name="CampoPesquisa" id="CampoPesquisa" value="<?php if (isset($_GET['CampoPesquisa'])) {
                                                                                                                            echo $pesquisa;
                                                                                                                        } ?>" placeholder="Pesquisa / Empresa ">
                <input type="image" name="pesquisa" id="pesquisa" src="https://img.icons8.com/ios/50/000000/search-more.png" />
                <td>
                    <select style="width: 110px; margin-top:0px; float:right; margin-right:70px; " id="campoLancamento" name="campoSituacao">
                        ...
                        ?>
                                ...
                                ?> <option value="<?php echo utf8_encode($linha_situacao_proposta["statusID"]); ?>" selected>
                                        <?php echo utf8_encode($linha_situacao_proposta["descricao"]); ?>
                                    </option>
                            ...
                            <tr id="linha_pesquisa">
                                ...
                                <td style="width: 150px;">
                                    <font size="2"> <?php if ($dataResponder == "0000-00-00") {
                                                        ...
                                                        echo formatardataB($dataResponder);
                                                    } ?></font>
                                </td>
                                ...
                                <td style="width: 100px;">
                                    <font size="2"> <?php if ($DataFechamento == "0000-00-00") {
                                                        ...
                                                        echo formatardataB($DataFechamento);
                                                    } ?></font>
                                </td>
                                <td style="width: 100px;">
                                ...
                                <td style="width: 40px;">
                                    <font size="3"><?php if ($status == 3) { ?>
                                        ...
                                        <?php
                                                        ...
                                                        echo '<i class="fa-solid fa-hand-holding-hand" title="Ganho Parcial"></i>';
                                                    } elseif ($status == 5) {
                                        ?>
                                ...
                                <td style="width: 50px;">
                                    <a target="blank" href="pdfCotacao.php?codigo=<?php echo $codCotacao; ?>&cliente=<?php echo $clienteID; ?>&compradorID=<?php echo $comprador; ?>">
...
<script>
    $('#pesquisa').click(function() {
        ...
        var desc_prod = document.getElementById('CampoProduto').value
        if(desc_prod!=""){
        var janela = "consultar_produto_cotacao.php?descr_prod=" + desc_prod;
