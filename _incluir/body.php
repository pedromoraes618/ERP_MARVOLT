    ...
    <div id="menulateral">
        ...
        <nav>
            ...
            <ul>
                ...
                <?php if ($nivel !=  6) { ?>
                    <li> <a onclick="window.open('../../../marvolt/lembrete/lembrete.php', 
                ...
                <?php if ($nivel == 2 or $nivel == 4 or $nivel ==  5) { ?>
                    <li><a>Cotação<i class="fa-solid fa-arrow-down"></i></a>
                        <ul>
                            ...
                            <!-- <li><a href="../../../marvolt/cotacao/verificar_email.php">Email / Cotação</a></li> -->
                    ...
                    <li><a>Financeiro<i class="fa-solid fa-arrow-down"></i></a>
                        <ul>
                            ...
                            <li><a href="../../../marvolt/financeiro/relatorio_apagar_receber.php">Relatórios Pagamentos e
                                    Recebimentos</a></li>
                            <li><a href="../../../marvolt/financeiro/extrato_fiscal/consulta_extrato_fiscal.php">Extrato Fiscal</a></li>
                            <!-- <li><a href="../../../marvolt/nota_fiscal/consulta_extrato_fiscal.php">Extrato fiscal</a></li> -->
                        </ul>
                    </li>
                    ...
                    <li><a>Configuração<i class="fa-solid fa-arrow-down"></i></a>
                        <ul>
                            <?php if ($nivel == 4 or $nivel ==  5) { ?>
                                ...
                                <li><a href="../../../marvolt/configuracao/empresa/registro_empresa.php?codEmpresa=<?php echo 1 ?>">Empresa</a>
                                </li>
                            ...
                            <li><a href="../../../marvolt/configuracao/forma_pagamento/consultar_forma_pagamento.php">Forma
                                    de Pagamento</a></li>
                            <li><a href="../../../marvolt/configuracao/sub_grupo_despesa_receita/consultar_subgrupo.php">SubGrupo</a>
                            </li>
                            <?php if ($nivel == 4 or $nivel ==  5) { ?>
