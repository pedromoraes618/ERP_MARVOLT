...
if (!$detalhe) {
    ...
    $grupo_clientes_b = utf8_encode($dados_detalhe["grupo_cliente"]);
                        ...
                        <div style="width: 700px; ">
                            <tr>
                                <td>
                                    ...
                                    <input readonly type="text" size="10" id="txtcodcliente" name="txtcodcliente" value="<?php echo $clienteID; ?>">
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" size=60 name="txtrazaosocial" id="txtrazaosocial" value="<?php echo $razao_social ?>">
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input required type="text" size=30 name="cidade" id="cidade" value="<?php echo $cidade ?>">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <input type="text" size=30 id="telefone" name="telefone" value="<?php echo $telefone ?>">
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <textarea rows=4 cols=60 name="observacao" id="observacao"><?php echo $observacao ?></textarea>
                                </td>
                    ...
                    <table style="float:right; width:700px; margin-top:50px;">
                        <tr>
                            <td>
                                ...
                                <input type="text" size=55 id="txtnomefantasia" name="txtnomefantasia" value="<?php echo $nome_fantasia ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="inscricao_estadual" style="width:120px;"><b>Insc Estadual:</b></label>
                                <input type="text" size=20 id="inscricao_estadual" name="inscricao_estadual" value="<?php echo $inscricao_estadual ?>">
                                <label for="cft"><b>Gp. Empresa:</b></label>
                                <select style="width: 175px;" id="grupo_cliente" name="grupo_cliente">
                                    <option value="0">Não definido</option>
                                    <?php
                                    while ($linha = mysqli_fetch_assoc($consultar_grupo_cliente)) {
                                        $grupo_cliente_principal  = $linha["cl_id"];
                                        if ($grupo_clientes_b == $grupo_cliente_principal) {
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" size=55 id="endereco" name="endereco" value="<?php echo $endereco; ?>">
                                <input type="hidden" size=10 id="ibge" name="ibge" value="<?php echo $codigo_cidadeB; ?>">
                        ...
                        <tr>
                            <td>
                                <label for="informacao_bancaria" style="width:120px;"><b>Informação
                                        bancaria:</b></label>
                                <input type="text" size=60 id="informacao_bancaria" name="informacao_bancaria" value="<?php echo $informacao_bancaria ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <label for="conta_agencia" style="width:120px;"><b>Conta Agência:</b></label>
                                <input type="text" size=30 id="conta_agencia" name="conta_agencia" value="<?php echo $conta_agencia ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>
