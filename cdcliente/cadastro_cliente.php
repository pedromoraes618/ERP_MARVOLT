...
if(isset($_POST["enviar"])){
  ...
  $grupo_cliente = utf8_decode($_POST["grupo_cliente"]);
                    ...
                    <table style="float:right; width:700px; margin-top:50px;">
                        ...
                        <tr>
                            <td>
                                ...
                                <select style="width: 150px;" name="grupo_cliente" id="grupo_cliente">
                                    <option value="0">Não defenido</option>
                                    <?php  while($linha  = mysqli_fetch_assoc($consultar_grupo_cliente)){
                                    $grupo_cliente_principal = utf8_encode($linha["cl_id"]);
                                    if(!isset($grupo_cliente)){
                                    ...
                                    if($grupo_cliente==$grupo_cliente_principal){
...
?>
                        ...
                        <tr>
                            <td>
                                ...
                                <select style="width: 200px;" name="cft" id="cft">
...
?>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" size=55.6 id="logradouro" name="endereco"
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" size=20 id="cep" name="cep" data-mask="00000-000"
