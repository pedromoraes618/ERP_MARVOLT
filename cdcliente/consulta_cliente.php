...
if($tipo =="0"){
$clientes .= " WHERE  nome_fantasia LIKE  '%{$nome_cliente}%'   order by nome_fantasia ";
}else{
$clientes .= " WHERE  nome_fantasia LIKE '%{$nome_cliente}%' and  clienteftID = '{$tipo}'  order by nome_fantasia ";
}
        ...
        <form action="consulta_pdcompra.php" method="get">
           ...
           ?>
                    ...
                    <tr id="linha_pesquisa">
                        ...
                        <td style="width:120px;">
                            <font size="2"> <?php echo formatDateB($ultimo_pd_fechamento);?></font>
                        </td>
...
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">
                        ...
                        <td id="botaoEditar">
                            <a
                                onclick="window.open('historico_cliente/consultar_hst.php?codigo=<?php echo $Idcliente;?>&nfantasia=<?php echo $nome_fantasia ?>', 
'Titulo da Janela', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1500, HEIGHT=900');">

                                <button type="button" name="Editar">Historico</button>
